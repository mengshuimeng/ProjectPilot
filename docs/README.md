...
1. [项目总览](overview.md)  
   了解 ProjectPilot V2 解决什么问题、当前完成了什么、还剩哪些可优化点。
...
4. [Harness Engineering 设计](harness_design.md)  
   对应课程要求，说明上下文管理、外部工具调用、验证反馈闭环。

5. [数据契约](data_contracts.md)  
   说明 `documents.json`、`profile.json`、`verify_report.json`、`meta/evidence` 的主要字段。

6. [质量控制与测试](quality_and_testing.md)  
   说明文本清洗、展示摘要、字段去重、校验器和测试覆盖。

7. [Demo 录屏指南](demo_guide.md)  
   提供 3 分钟答辩 Demo 的推荐操作路线和讲解词。

8. [项目结构说明](project_structure.md)  
   说明哪些文件应该提交，哪些运行时文件不应该提交。

9. [开发记录](development_record.md)  
